...
def meanshift_clustering(points, quantile=0.1, n_samples=1000):
    point1 = np.array(points)
    bandwidth = estimate_bandwidth(point1, quantile=quantile, n_samples=n_samples)
...
def draw_clusters(img, points, labels, name='ololo'):
